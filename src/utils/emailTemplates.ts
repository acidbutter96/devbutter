...
export const emailTemplates: EmailTemplate[] = [
    ...
    previewRecipients: {
      ...
      adminEmail: "oi@devbutter.com",
            ...
            message: "Hi Ambra! I am building a live course platform and would love to chat about partnering on the branding and the site.\n\nI have a few references and would like to know about your availability over the next few weeks.",
        },
        buildHtml: data => {
...
<tr>
  <td style="padding:24px 32px 32px;">
    ...
    previewRecipients: {
      from: "Ambra | DevButter <oi@devbutter.com>",
      to: "Luna Costa <luna.costa@example.com>",
    },
        previewData: {
            userName: "Luna Costa",
